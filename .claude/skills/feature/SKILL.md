...
- Create entity class in `src/main/java/com/project/codingtest/domain/{domain}/domain/entity/`
...
- Create repository interface in `src/main/java/com/project/codingtest/domain/{domain}/domain/repository/`
...
- Create in `src/main/java/com/project/codingtest/domain/{domain}/domain/service/`
...
- Create in `src/main/java/com/project/codingtest/domain/{domain}/application/usecase/`
...
- Create in `src/main/java/com/project/codingtest/domain/{domain}/presentation/`
...
- Request DTO: `src/main/java/com/project/codingtest/domain/{domain}/application/dto/request/`
- Response DTO: `src/main/java/com/project/codingtest/domain/{domain}/application/dto/response/`
- ErrorCode: `src/main/java/com/project/codingtest/domain/{domain}/application/exception/`
- ResponseCode: `src/main/java/com/project/codingtest/domain/{domain}/presentation/response/`
